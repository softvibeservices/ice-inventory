...
export default function DeliveryOverview({
  ...
  // ========= RENDER =========
  return (
    <section className="flex-1 bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 lg:p-8 flex flex-col">
      ...
      {loadingOrders ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 flex-1">
          {/* Pending / On the Way */}
          <div className="border rounded-lg p-3 sm:p-4 bg-blue-50 flex flex-col h-[420px]">
            ...
            {pendingOrOnTheWay.length === 0 ? (
              ...
              <div className="flex-1 min-h-0 overflow-y-auto pr-1 sm:pr-2" style={{
                scrollbarWidth: 'thin',
          ...
          <div className="border rounded-lg p-3 sm:p-4 bg-green-50 flex flex-col h-[420px]">
            <div className="flex items-center gap-2 mb-3 flex-shrink-0">
            ...
            {deliveredButUnsettled.length === 0 ? (
              ...
              <div className="flex-1 min-h-0 overflow-y-auto pr-1 sm:pr-2" style={{
                ...
                <style>{`
                  .bg-green-50 .flex-1.overflow-y-auto::-webkit-scrollbar {
                    width: 8px;
                  }
                  .bg-green-50 .flex-1.overflow-y-auto::-webkit-scrollbar-track {
                    background: #dcfce7;
                    border-radius: 4px;
                  }
                  .bg-green-50 .flex-1.overflow-y-auto::-webkit-scrollbar-thumb {
                    background: #86efac;
                    border-radius: 4px;
                  }
                  .bg-green-50 .flex-1.overflow-y-auto::-webkit-scrollbar-thumb:hover {
                    background: #4ade80;
                  }
                `}</style>
                <ul className="space-y-2">
