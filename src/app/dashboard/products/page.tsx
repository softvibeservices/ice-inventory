  ...
  const filtered = useMemo(() => {
    ...
    list.sort((a, b) => {
      switch (sortMode) {
        ...
        case "default":
        default:
          // keep newest first if createdAt available, otherwise as-is
          ...
          {filtered.length === 0 ? (
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M3 14a1 1 0 011-1h3v2H5a1 1 0 01-1-1zm9-2v3a1 1 0 01-1 1H9v-4h3zm2-1h-1v4h1a1 1 0 001-1v-3a1 1 0 00-1-1zm-3-4a1 1 0 00-2 0v4.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3c.39.39 1.024.39 1.414 0l3-3a1 1 0 10-1.414-1.414L11 11.586V7z"
                  clipRule="evenodd"
                />
              </svg>
